...
export function Hero() {
  return (
    <section
      ...
      className="relative min-h-screen overflow-hidden bg-sage dark:bg-forest"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 flex flex-col pt-[9.375rem]">
        <div className="w-full max-w-[800px] pb-24">
          ...
          <h1 className="font-display font-bold tracking-tight mb-8">
            <motion.span
              className="block text-[clamp(2.25rem,5vw,4.5rem)] text-forest dark:text-white leading-[1.1] mb-3"
            ...
            <motion.span
              className="block text-[clamp(2.25rem,5vw,4.5rem)] text-forest dark:text-white leading-[1.1]"
              initial={{ opacity: 0, y: 18 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <p className="text-[1.5rem] text-forest dark:text-white leading-relaxed font-sans">
          ...
          >
            ...
            <a
              ...
              className={cn(
                ...
                "bg-forest hover:bg-forest/85 text-white dark:bg-white dark:text-forest dark:hover:bg-white/90 rounded-full px-8 gap-2 transition-colors duration-300 shadow-none cursor-pointer"
              )}
            >
            ...
            <button
              ...
              className={cn(
                ...
                "rounded-full px-8 border-forest/30 text-forest dark:text-white hover:bg-forest/8 dark:border-white/30 dark:hover:bg-white/10 shadow-none transition-colors duration-300 cursor-pointer"
              )}
            >
              Get in touch
            </button>
